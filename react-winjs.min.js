...
var _winjs = require('winjs');

var _winjs2 = _interopRequireDefault(_winjs);
...
function fireEvent(element, eventName) {
    ...
    eventObject.initCustomEvent(eventName, true, // bubbles
    false, // cancelable
    null // detail
    );
...
function processChildren(componentDisplayName, children, childComponentsMap) {
    ...
    _react2.default.Children.forEach(children, function (component) {
        if (component) {
            if (component.ref) {
...
var PropHandlers = {
    ...
    property: function property(propType) {
        return {
            propType: propType,
    ...
    // focus move.
    focusProperty: function focusProperty(propType) {
        return {
            propType: propType,
    ...
    domProperty: function domProperty(propType) {
        return {
            propType: propType,
    ...
    domAttribute: function domAttribute(propType) {
        return {
            propType: propType,
    ...
    event: {
        propType: _propTypes2.default.func,
    ...
    winControlStyle: {
        propType: _propTypes2.default.object,
    ...
    propertyWithMount: function PropHandlers_propertyWithMount(winControlProperty) {
        return {
            propType: _propTypes2.default.element,
            preCtorInit: function propertyWithMount_preCtorInit(element, options, data, displayName, propName, value) {
                if (value) {
                    ...
                    _reactDom2.default.render(value, data[propName]);
            ...
            update: function propertyWithMount_update(winjsComponent, propName, oldValue, newValue) {
                ...
                if (newValue) {
                    ...
                    _reactDom2.default.render(newValue, element);
                    if (winControl[winControlProperty] !== element) {
                        winControl[winControlProperty] = element;
                    }
                } else if (oldValue) {
                    element && _reactDom2.default.unmountComponentAtNode(element);
                    ...
                    if (version === winjsComponent.data[propName].version) {
                        ...
                        if (newValue) {
                            ...
                            if (oldElement && oldElement !== newElement) {
                                _reactDom2.default.unmountComponentAtNode(oldElement);
                            }

                            _reactDom2.default.render(newValue, newElement);
                            winjsComponent.data[propName].element = newElement;
                        } else if (oldValue) {
                            oldElement && _reactDom2.default.unmountComponentAtNode(oldElement);
    ...
    syncChildrenWithBindingList: function PropHandlers_syncChildrenWithBindingList(bindingListName) {
        return {
            preCtorInit: function syncChildrenWithBindingList_preCtorInit(element, options, data, displayName, propName, value) {
                ...
                options[bindingListName] = new _winjs2.default.Binding.List(latest.childComponents.map(function (winjsChildComponent) {
            ...
            update: function syncChildrenWithBindingList_update(winjsComponent, propName, oldValue, newValue) {
                ...
                if (bindingList) {
                    ...
                    winjsComponent.winControl[bindingListName] = new _winjs2.default.Binding.List(latest.childComponents.map(function (winjsChildComponent) {
                        return winjsChildComponent.winControl;
                    }));
                }
...
function defineControl(options) {
    ...
    var TypeComponent = function (_Component) {
        _inherits(TypeComponent, _Component);

        function TypeComponent(props) {
            _classCallCheck(this, TypeComponent);

            return _possibleConstructorReturn(this, (TypeComponent.__proto__ || Object.getPrototypeOf(TypeComponent)).call(this, props));
        }
        ...
        _createClass(TypeComponent, [{
            ...
            value: function componentDidMount() {
                initWinJSComponent(this, _reactDom2.default.findDOMNode(this), this.props);
            }
        }, {
...
function renderRootlessComponent(component) {
    var html = _server2.default.renderToStaticMarkup(component);
...
function WinJSChildComponent(component) {
    // implements IWinJSChildComponent
    // Clone the component so a ref isn't generated.
    var clonedComponent = _react2.default.cloneElement(component, { ref: null });
...
var defaultPropHandlers = {
    ...
    // more generically.
    id: PropHandlers.domProperty(_propTypes2.default.string),
    "aria-controls": PropHandlers.domAttribute(_propTypes2.default.any),
    "aria-expanded": PropHandlers.domAttribute(_propTypes2.default.any)
};
...
function updateWithDefaults(controlApis) {
    Object.keys(controlApis).forEach(function (controlName) {
        ...
        spec.winjsControl = spec.winjsControl || _winjs2.default.UI[winjsControlName];
        spec.displayName = spec.displayName || winjsControlName;
        spec.propHandlers = merge(defaultPropHandlers, // Common to all WinJS controls
        ...
        propHandlers: {
            ...
            flyoutComponent: {
                ...
                update: function FlyoutCommand_flyoutComponent_update(winjsComponent, propName, oldValue, newValue) {
                    ...
                    var instance = _reactDom2.default.render(newValue, data.flyoutHost);
                ...
                dispose: function FlyoutCommand_flyoutComponent_dispose(winjsComponent, propName) {
                    ...
                    if (data && data.flyoutHost) {
                        _reactDom2.default.unmountComponentAtNode(data.flyoutHost);
...
var ControlApis = updateWithDefaults({
    AppBar: {
        propHandlers: {
            opened: PropHandlers.focusProperty(_propTypes2.default.bool),
    ...
    AutoSuggestBox: {},
    BackButton: {
        preCtorInit: function preCtorInit(element, options, data, displayName) {
    ...
    ContentDialog: {
        propHandlers: {
            hidden: PropHandlers.focusProperty(_propTypes2.default.bool),
            children: PropHandlers.mountTo(function (winjsComponent) {
    ...
    Flyout: {
        ...
        render: function render(component) {
            return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: "win-react-flyout-mount-point" }));
        },
        propHandlers: {
            hidden: PropHandlers.focusProperty(_propTypes2.default.bool),
            children: PropHandlers.mountTo(function (winjsComponent) {
    ...
    ListView: {
        propHandlers: {
            currentItem: PropHandlers.focusProperty(_propTypes2.default.any),
    ...
    Menu: {
        propHandlers: {
            ...
            children: {
                ...
                update: function update(winjsComponent, propName, oldValue, newValue) {
                    // TODO: dispose
                    _reactDom2.default.render(_react2.default.createElement('div', null, newValue), winjsComponent.winControl.element);
                }
            }
        }
    },
    ...
    SplitView: {
        propHandlers: {
            paneOpened: PropHandlers.focusProperty(_propTypes2.default.bool),
    ...
    SplitViewPaneToggle: {
        ...
        propHandlers: {
            ...
            paneOpened: {
                propType: _propTypes2.default.bool,
                update: function paneOpened_update(winjsComponent, propName, oldValue, newValue) {
                    ...
                    if (!data) {
                        data = {
                            ...
                            ariaExpandedMutationObserver: new _winjs2.default.Utilities._MutationObserver(function () {
...
ReactWinJS.reactRenderer = function reactRenderer(componentFunction) {
    ...
    var renderItem = function renderItem(item) {
        ...
        _reactDom2.default.render(componentFunctionBound(item), element);
        _winjs2.default.Utilities.markDisposable(element, function () {
    ...
    return function itemRenderer(itemOrItemPromise) {
        ...
        return _winjs2.default.Promise.is(itemOrItemPromise) ? itemOrItemPromise.then(renderItem) : renderItem(itemOrItemPromise);
    };
};
